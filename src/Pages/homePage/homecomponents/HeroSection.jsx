  ...
  return (
    <>
      <div className="bg-imagee sm:pb-[700px]">
        <section className="bg-transparent text-white relative py-64 px-8  md:px-16 h-full">
          <div className="absolute top-2 left-1/2 transform -translate-x-1/2 bg-blue-800/50 border md:mt-[150px] border-blue-500 sm:w-20px rounded-full px-8 py-1 text-sm flex items-center gap-2 lg:mt-36">
