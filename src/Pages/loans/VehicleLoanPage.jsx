...
>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-4 lg:px-0">
        <div className="mt-6 lg:mt-[55px] lg:ml-[120px]">
          ...
          <p className="text-lg sm:text-lg lg:text-[17px] leading-[20px] sm:leading-[25px] lg:leading-[29px] text-gray-800 mt-4 lg:mt-3">
          ...
          <p className="text-lg sm:text-lg lg:text-[17px]  leading-[20px] sm:leading-[25px] lg:leading-[29px] text-gray-800">
